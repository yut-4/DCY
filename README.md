...
- ORMT is a separate renderer in `src/ormt.hpp`. Minimal lines omit paths and hashes but preserve entity IDs, which can be resolved to exact source in the current generation. They are lossy representations.
